(ns musitron.midi-parser
  (:import (java.io File)
           (javax.sound.midi MidiSystem Sequence MidiMessage MidiEvent ShortMessage Track)))

;;A MIDI parser written by Vishnu Menon (c) 2013
;;Distributed under Eclipse Public License
;;parse-midi-file takes a MIDI file and returns a hash map like
;; [{:sound {45 80}, :duration 500}
;;  {:sound {69 90}, :duration 400}] 
;;where the two :sound values are MIDI note and velocity, respectively.
;;That example shows two notes in sequence.  A :sound {} represents silence.
